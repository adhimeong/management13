	...
	<tr>
		...
		<td>
			<form action="/absenguru/{{$data->id}}" method="POST">
				<a href="/absenguru/{{ $data->id }}" class="btn waves-effect waves-light green"><i class="mdi-action-assignment"></i></a>
				<a href="/absenguru/{{ $data->id }}/edit" class="btn waves-effect waves-light orange"><i class="mdi-content-create"></i></a>
